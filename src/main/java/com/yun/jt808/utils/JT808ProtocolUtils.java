...
public class JT808ProtocolUtils {
	...
	public int generateMsgBodyProps(int msgLen, int enctyptionType, boolean isSubPackage, int reversed1415) {
	...
	public byte[] generateMsgHeader(String phone, int msgId, byte[] body, int msgBodyProps, int flowId)
			throws Exception {
		ByteArrayOutputStream baos = null;
		try {
			baos = new ByteArrayOutputStream();
